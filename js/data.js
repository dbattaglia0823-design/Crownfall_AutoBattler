...
const REWARDS = [
  ...
  { name: "Living Aegis", rarity: "Legendary", stats: { armor: 8, maxHp: 180, regen: 3 } },
  { name: "Aegis Reservoir", rarity: "Legendary", stats: { shieldCapPercent: 0.12, maxHp: 150 } },
...
const SHOP_ITEMS = [
  ...
  { name: "Apothecary Flask", rarity: "Common", cost: 40, stats: { maxHp: 32 } },
  { name: "Tempered Plates", rarity: "Common", cost: 50, stats: { armor: 2 } },
  { name: "Keen-Eye Talisman", rarity: "Rare", cost: 50, stats: { critChance: 0.1 } },
  { name: "Knight's Ration", rarity: "Common", cost: 35, stats: { maxHp: 20, regen: 2 } },
  { name: "Duelist's Oil", rarity: "Rare", cost: 60, stats: { damage: 12, critChance: 0.05 } },
  ...
  { name: "Spiked Greaves", rarity: "Rare", cost: 65, stats: { armor: 3, attackSpeed: 0.12 } },
  { name: "Bloodletter Kit", rarity: "Epic", cost: 90, stats: { damage: 50, critChance: 0.1, maxHp: -30 } },
  { name: "Crown Insurance", rarity: "Epic", cost: 95, stats: { maxHp: 90, regen: 4 } },
  { name: "Merchant's Star Chart", rarity: "Epic", cost: 85, stats: { luck: 5, maxHp: 60 } },
  { name: "Royal Armament", rarity: "Legendary", cost: 130, stats: { damage: 85, armor: 6, critChance: 0.12 } },
  { name: "Fatebound Crown", rarity: "Legendary", cost: 120, stats: { luck: 7, attackSpeed: 0.4 } }
];
